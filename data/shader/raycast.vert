...
vec3 intersectRayWithPlane(vec3 origin, vec3 dir, float yPlane) {
    ...
    // return vec3(1.485458, 0.000000, -15.940857);
    // return origin;
    return origin + dir * t;
}
...
void main() {
    ...
    // vec3 rayOrigin = vec3(-10.181144, 22.084320, -52.555370);
    ...
    if (gl_VertexID % 2 == 0) {
      ...
      // Color = vec3(clamp(abs(rayDir.y), 0.0, 1.0));
        ...
        // gl_Position = projection * view * vec4(vec3(1.485458, 0.000000, -15.940857),1.0);
